...
class UntrustedConcurrentArena : public Allocator {
 public:
  ...
  explicit UntrustedConcurrentArena(size_t block_size = Untrusted_Arena::kMinBlockSize,
 ...
 private:
  ...
  UntrustedConcurrentArena(const UntrustedConcurrentArena&) = delete;
  UntrustedConcurrentArena& operator=(const UntrustedConcurrentArena&) = delete;
};
