...
__thread size_t UntrustedConcurrentArena::tls_cpuid = 0;
#endif
...
UntrustedConcurrentArena::UntrustedConcurrentArena(size_t block_size, AllocTracker* tracker,
...
UntrustedConcurrentArena::Shard* UntrustedConcurrentArena::Repick() {
