...
class Untrusted_Arena : public Allocator {
 public:
  // No copying allowed
  Untrusted_Arena(const Untrusted_Arena&) = delete;
  void operator=(const Arena&) = delete;


  static const size_t kInlineSize = 0;
  ...
  explicit Untrusted_Arena(size_t block_size = kMinBlockSize,
